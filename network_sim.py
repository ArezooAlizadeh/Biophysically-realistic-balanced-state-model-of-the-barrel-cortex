...
for g in gvariable:
    ...
    # Spikes for monitor 4 (excitatory and inhibitory)
    np.save(f'{base_path}/Spikestest_4e_i_g={g}_r={r}.npy', spikemon_4_e.i)
    np.save(f'{base_path}/Spikestest_4e_t_g={g}_r={r}.npy', spikemon_4_e.t)
    np.save(f'{base_path}/Spikestest_4i_i_g={g}_r={r}.npy', spikemon_4_i.i)
    np.save(f'{base_path}/Spikestest_4i_t_g={g}_r={r}.npy', spikemon_4_i.t)
    
    # Spike trains for monitor 4
    np.save(f'{base_path}/Spiketraintest_4e_g={g}_r={r}.npy', [spikemon_4_e.spike_trains()])
    np.save(f'{base_path}/Spiketraintest_4i_g={g}_r={r}.npy', [spikemon_4_i.spike_trains()])
    
    # Spikes for L2/3 monitor (excitatory and inhibitory)
    np.save(f'{base_path}/Spikestest_23e_i_g={g}_r={r}.npy', spikemon_23_e.i)
    np.save(f'{base_path}/Spikestest_23e_t_g={g}_r={r}.npy', spikemon_23_e.t)
    np.save(f'{base_path}/Spikestest_23i_i_g={g}_r={r}.npy', spikemon_23_i.i)
    np.save(f'{base_path}/Spikestest_23i_t_g={g}_r={r}.npy', spikemon_23_i.t)
    
    # Spike trains for L2/3 monitor
    np.save(f'{base_path}/Spiketraintest_23i_g={g}_r={r}.npy', [spikemon_23_i.spike_trains()])
    np.save(f'{base_path}/Spiketraintest_23e_g={g}_r={r}.npy', [spikemon_23_e.spike_trains()])