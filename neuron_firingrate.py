...
# Load Spike data
        # L4
        print('Loading e4')
        e4 = np.load(f'{base_path}/Spikestest_4e_i_g={g}_r={r}.npy')
        
        print('Loading i4')
        i4 = np.load(f'{base_path}/Spikestest_4i_i_g={g}_r={r}.npy')
        ...
        # L2/3
        print('Loading e23')
        e23 = np.load(f'{base_path}/Spikestest_23e_i_g={g}_r={r}.npy')
        
        print('Loading i23')
        i23 = np.load(f'{base_path}/Spikestest_23i_i_g={g}_r={r}.npy')
...
f = open(f'{base_path}\\firingfreqs_values.pckl', 'wb')
...
for g in gvariable:
    ...
    e4 = np.load(f'{base_path}\\Spikestest_4e_i_g=%g_r=20.npy' %(g),allow_pickle = True)
    i4 = np.load(f'{base_path}\\Spikestest_4i_i_g=%g_r=20.npy' %(g),allow_pickle = True)
    # load spike trains
    e4t = np.load(f'{base_path}\\Spiketraintest_4e_g=%g_r=20.npy' %(g),allow_pickle=True)
    i4t = np.load(f'{base_path}\\Spiketraintest_4i_g=%g_r=20.npy' %(g),allow_pickle=True)
    ...
    # L2/3 --- load spikes
    e23 = np.load(f'{base_path}\\Spikestest_23e_i_g=%g_r=20.npy' %(g),allow_pickle=True)
    i23 = np.load(f'{base_path}\\Spikestest_23i_i_g=%g_r=20.npy' %(g),allow_pickle=True)
    # load spike trains
    e23t = np.load(f'{base_path}\\Spiketraintest_23e_g=%g_r=50.npy' %(g),allow_pickle=True)
    i23t = np.load(f'{base_path}\\Spiketraintest_23i_g=%g_r=50.npy' %(g),allow_pickle=True)    
    ...
    # L4 ---- load spikes
    e4_3 = np.load(f'{base_path}\\Spikestest_4e_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    i4_3 = np.load(f'{base_path}\\Spikestest_4i_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    # load spike trains
    e4t_3 = np.load(f'{base_path}\\Spiketraintest_4e_g=%g_r=50.npy' %(g),allow_pickle=True)
    i4t_3 = np.load(f'{base_path}\\Spiketraintest_4i_g=%g_r=50.npy' %(g),allow_pickle=True)    
    ...
    # L2/3 ---- load spikes
    e23_3 = np.load(f'{base_path}\\Spikestest_23e_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    i23_3 = np.load(f'{base_path}\\Spikestest_23i_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    # load spike trains
    e23t_3 = np.load(f'{base_path}\\Spiketraintest_23e_g=%g_r=50.npy' %(g),allow_pickle=True)
    i23t_3 = np.load(f'{base_path}\\Spiketraintest_23i_g=%g_r=50.npy' %(g),allow_pickle=True)       
    ...
    # L4 ---- load spikes
    e4_4 = np.load(f'{base_path}\\Spikestest_4e_i_g=%g_r=20.npy' %(g),allow_pickle=True)
    i4_4 = np.load(f'{base_path}\\Spikestest_4i_i_g=%g_r=20.npy' %(g),allow_pickle=True)
    
    # load spike trains
    e4t_4 = np.load(f'{base_path}\\Spiketraintest_4e_g=%g_r=20.npy' %(g),allow_pickle=True)
    i4t_4 = np.load(f'{base_path}\\Spiketraintest_4i_g=%g_r=20.npy' %(g),allow_pickle=True)  
    ...
    # L2/3 -- load spikes
    e23_4 = np.load(f'{base_path}\\Spikestest_23e_i_g=%g_r=20.npy' %(g),allow_pickle=True)
    i23_4 = np.load(f'{base_path}\\Spikestest_23i_i_g=%g_r=20.npy' %(g),allow_pickle=True)
    # load spike trains
    e23t_4 = np.load(f'{base_path}\\Spiketraintest_23e_g=%g_r=20.npy' %(g),allow_pickle=True)
    i23t_4 = np.load(f'{base_path}\\Spiketraintest_23i_g=%g_r=20.npy' %(g),allow_pickle=True)   
    ...
    # L4 ---- load spikes
    e4_5 = np.load(f'{base_path}\\Spikestest_4e_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    i4_5 = np.load(f'{base_path}\\Spikestest_4i_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    # load spike trains
    e4t_5 = np.load(f'{base_path}\\Spiketraintest_4e_g=%g_r=50.npy' %(g),allow_pickle=True)
    i4t_5 = np.load(f'{base_path}\\Spiketraintest_4i_g=%g_r=50.npy' %(g),allow_pickle=True)  
    ...
    # L2/3 -- load spikes
    e23_5 = np.load(f'{base_path}\\Spikestest_23e_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    i23_5 = np.load(f'{base_path}\\Spikestest_23i_i_g=%g_r=50.npy' %(g),allow_pickle=True)
    # load spike trains   
    e23t_5 = np.load(f'{base_path}\\Spiketraintest_23e_g=%g_r=50.npy' %(g),allow_pickle=True)
    i23t_5 = np.load(f'{base_path}\\Spiketraintest_23i_g=%g_r=50.npy' %(g),allow_pickle=True)  
...
f = open(f'{base_path}\\ff_vals.pckl', 'wb')
pickle.dump([output_spikemon_L4, output_spikemon_L23], f)
f.close()