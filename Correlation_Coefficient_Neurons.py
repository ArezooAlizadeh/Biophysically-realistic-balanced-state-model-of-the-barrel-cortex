...
for g in gvariable:
    ...
    train_e_4 = np.load(f'{base_path}\\Spiketraintest_4e_g=%g_r=20.npy'%(g),
                    allow_pickle=True)[0]
    
    print('Loading spike trains for L4 - inhibitory, at g = ' + str(g))
    train_i_4 = np.load(f'{base_path}\\Spiketraintest_4e_g=%g_r=20.npy'%(g),
                    allow_pickle=True)[0]

    # L2/3
    print('Loading spike trains for L2/3 - excitatory, at g = ' + str(g))
    train_e_23 = np.load(f'{base_path}\\Spiketraintest_23e_g=%g_r=20.npy'%(g),
                     allow_pickle=True)[0]
   
    print('Loading spike trains for L2/3 - inhibitory, at g = ' + str(g))
    train_i_23 = np.load(f'{base_path}\\Spiketraintest_23i_g=%g_r=20.npy'%(g),
                     allow_pickle=True)[0]
    ...
    ss = f'{base_path}\\coeff_matrix_g=%g_r=20.pckl'%(g)
    f = open(ss, 'wb')
